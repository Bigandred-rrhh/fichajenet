...
export default function InformePDF() {
  ...
  const mesTexto = datos ? format(new Date(datos.mes+"-01"),"MMMM yyyy",{locale:es}) : "";
...
`}</style>
        ...
        <div className="card" style={{ marginBottom:20 }}>
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:12 }}>
            <div className="form-group" style={{ marginBottom:0 }}>
              ...
              <select className="form-input form-select" value={empresa} onChange={e=>{setEmpresa(e.target.value);setEmpleado("");}}>
            ...
            <div className="form-group" style={{ marginBottom:0 }}>
              ...
              <select className="form-input form-select" value={empleado} onChange={e=>setEmpleado(e.target.value)}>
          ...
          <div style={{ marginTop:14 }}>
            <button className="btn btn-primary" onClick={generarDatos} disabled={!empleado||cargando}>
      ...
      {datos && (
        <div className="print-area" style={{
          ...
          padding:"32px 40px", maxWidth:800, margin:"0 auto"
        }}>
          {/* Cabecera */}
          ...
          {/* Nota legal */}
          <div style={{ marginTop:16, background:"#FFF3CD", borderRadius:8,
